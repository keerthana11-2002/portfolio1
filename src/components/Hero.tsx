    ...
    <section className="min-h-screen flex items-center bg-gradient-to-br from-blue-200 via-purple-100 to-pink-50">
      <div className="container mx-auto px-4 py-28 md:ml-28">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <span className="text-blue-900 ">ISTQB CTFL certified QA Tester </span> with hands-on experience in manual and automation testing of web applications and APIs. Skilled in Selenium WebDriver with Java, TestNG, and API testing using Postman. Passionate about ensuring software quality through effective test design and reliable automation.
            ...
            <div className="flex gap-4">
              ...
              >
                <a href="https://drive.google.com/file/d/1OlqN7Ax6GxmYMVyxJkvah7FGMAFarevc/view?usp=sharing">Download CV</a>
              </motion.button>
              <motion.button
