...
//       <div className="container mx-auto px-4 py-20 md:ml-28">
...
//               Hi, I'm <span className='text-blue-800'>Keerthana</span>
//             </h1>
//             <h2 className='text-3xl mb-3'>Frontend Development</h2>
...
// <button className="px-5 py-3 border border-blue-600 text-blue-600 font-semibold rounded hover:bg-blue-600 hover:text-white transition-all duration-300">
//   Download CV
// </button>
// <button className="px-5 py-3 bg-green-500 text-white font-semibold rounded hover:bg-green-600 transition-all duration-300 ml-4">
//   Let's Connect
// </button>
...
//             >
//               {[
//                 { icon: <Github size={24} />,link:"https://github.com/keerthana11-2002", bg: 'bg-gray-800 hover:bg-gray-700' },
//                 { icon: <Linkedin size={24} />,link:"https://www.linkedin.com/in/keerthana-k-16b6442a0/", bg: 'bg-blue-600 hover:bg-blue-500' },
                 
//               ].map((item, index) => (
//                 <motion.a
//                   key={index}
//                   href={item.link}
//                   className={`p-2 ${item.bg} text-white rounded-full transition`}
